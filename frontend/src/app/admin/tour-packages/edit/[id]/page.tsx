            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {packageStatus.isPublished ? 'This package is currently published and visible to customers.' : 'This package is currently in draft mode and not visible to customers.'}
                </p>
              </div>
              <button
                type="button"
