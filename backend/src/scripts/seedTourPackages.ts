// Run this script to create a super-admin user and seed tour packages
...
async function seedTourPackagesData() {
  try {
    ...
    // Check if tour packages exist
    const existingPackages = await TourPackage.countDocuments();
    ...
    process.exit(0); // Ensure script exits completely
  }
}
